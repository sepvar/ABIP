...
\caption{\label{irl-tension}<idx><h></h><h></h></idx>{Force!Tension} Pull my finger.}
...
\begin{figure}
\hrule\hrule
\caption{\label{f-firstFBDangle} An updated version of \protect{<xref ref="" />f-firstFBDupdate}}, people pushing a box.}<idx><h></h><h></h></idx>{Free-Body Diagrams!Images}
